...
export const ShortsCard = ({
  ...
  return (
    <article
      ...
      className={`group relative flex h-[360px] w-[220px] flex-shrink-0 flex-col overflow-hidden rounded-3xl border bg-[#111111] transition hover:shadow-[0_24px_60px_rgba(0,0,0,0.5)] focus:outline-none ${
        watched
    ...
    >
      <div className="relative flex h-full w-full items-end overflow-hidden">
        ...
        <div className="relative z-10 flex w-full flex-col gap-3 px-4 pb-4">
          <span className="w-fit rounded-full border border-white/20 bg-black/40 px-3 py-1 text-[11px] uppercase tracking-[0.2em] text-white">
            {theme ? getThemeLabel(theme) : "Tema"}
          </span>
          <div className="text-sm font-semibold text-white line-clamp-3">
            {item.title}
          </div>
          <div className="text-[11px] uppercase tracking-[0.25em] text-[#b0b0b0]">
